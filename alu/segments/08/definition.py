...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.MusicCommand(
            ("flute voice", alu.measure_numbers([2, 3])),
            evans.talea([1], 16),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["b'", "bf'", "a'"]),
            evans.slur([3]),
            abjad.Dynamic("p"),
        ),
        # evans.MusicCommand(
        ...
        evans.MusicCommand(
            ...
            evans.talea([1], 16),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["b'", "bf'", "a'", "af'", "g'"]),
            evans.slur([5]),
            abjad.Dynamic("p"),
        ),
        evans.MusicCommand(
        ...
        evans.MusicCommand(
            ("oboe voice", alu.measure_numbers([2, 3])),
            evans.talea([1], 16, extra_counts=[1], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["fs'", "g'", "gs'", "a'"]),
            evans.slur([4]),
            abjad.Dynamic("p"),
        ),
        # evans.MusicCommand(
        ...
        evans.MusicCommand(
            ...
            evans.talea([1], 16, extra_counts=[1], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["fs'", "g'", "gs'", "a'", "as'"]),
            evans.slur([5]),
            abjad.Dynamic("p"),
        ),
        # evans.MusicCommand(
        ...
        evans.MusicCommand(
            ...
            evans.talea([1], 16, extra_counts=[1], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["fs'", "g'", "gs'", "a'", "as'", "b'"]),
            evans.slur([6]),
            abjad.Dynamic("p"),
        ),
        # CLARINET
        ...
        evans.MusicCommand(
            ("bass clarinet voice", alu.measure_numbers([2, 3])),
            evans.talea([1], 16, extra_counts=[2], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["b", "bf", "a", "b", "c'"]),
            evans.slur([5]),
            abjad.Dynamic("p"),
        ),
        # evans.MusicCommand(
        ...
        evans.MusicCommand(
            ...
            evans.talea([1], 16, extra_counts=[2], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["b", "bf", "a", "b", "c'", "af"]),
            evans.slur([6]),
            abjad.Dynamic("p"),
        ),
        # evans.MusicCommand(
        ...
        evans.MusicCommand(
            ...
            evans.talea([1], 16, extra_counts=[2], preprocessor=evans.make_preprocessor(quarters=True)),
            lambda _: rmakers.force_rest(abjad.select.get(_, abjad.index([0, 1, -1]))),
            evans.PitchHandler(["b", "bf", "a", "b", "c'", "af", "g"]),
            evans.slur([7]),
            abjad.Dynamic("p"),
        ),
        # BASSOON
        ...
        # ),
        evans.MusicCommand(
            ("violin 1 voice", alu.measure_numbers([1, 2, 3, 4])),
            evans.talea(
                [100],
                8,
                preamble=[-5],
            ...
            evans.PitchHandler(["a'"]),
            abjad.Dynamic("mp"),
            lambda _: abjad.tie(abjad.select.notes(_)),
            # alu.C_color,
        ),
        evans.MusicCommand(
        ...
        evans.MusicCommand(
            ("violin 1 voice", alu.measure_numbers([13, 14])),
            evans.make_tied_notes(),
            evans.PitchHandler([["gs'", "eqs''"]]),
            abjad.Dynamic("mp"),
            # alu.B_color,
        ),
        evans.MusicCommand(
        ...
        evans.MusicCommand(
            ("violin 1 voice", alu.measure_numbers([16, 17, 18])),
            evans.make_tied_notes(),
            evans.PitchHandler([["gs'", "c''"]]),
            abjad.Dynamic("mp"),
            # alu.B_color,
        ),
        # VIOLIN 2
        ...
        # ),
        evans.MusicCommand(
            ("violin 2 voice", alu.measure_numbers([1, 2, 3, 4])),
            evans.talea(
                [100],
                8,
                preamble=[-6],
        ...
        evans.MusicCommand(
            ("violin 2 voice", alu.measure_numbers([13, 14])),
            evans.make_tied_notes(),
            evans.PitchHandler([["bqs", "ds''"]]),
            abjad.Dynamic("mp"),
            # alu.B_color,
        ),
        evans.MusicCommand(
        ...
        evans.MusicCommand(
            ("violin 2 voice", alu.measure_numbers([16, 17, 18])),
            evans.make_tied_notes(),
        ...
        # ),
        evans.MusicCommand(
            ("viola voice", alu.measure_numbers([1, 2, 3, 4])),
            evans.talea(
                [100],
                8,
                preamble=[-4],
        ...
        evans.MusicCommand(
            ("viola voice", alu.measure_numbers([14, 15])),
            evans.make_tied_notes(),
            evans.PitchHandler([["cs", "g"]]),
            abjad.Dynamic("mp"),
            # alu.B_color,
        ),
        evans.MusicCommand(
            ("viola voice", alu.measure_numbers([16, 17, 18])),
            evans.make_tied_notes(),
        ...
        # ),
        evans.MusicCommand(
            ("cello voice", alu.measure_numbers([2, 3, 4])),
            evans.talea(
                [100],
                8,
                preamble=[-2],
        ...
        evans.MusicCommand(
            ("contrabass voice", alu.measure_numbers([16, 17, 18])),
            evans.make_tied_notes(),
