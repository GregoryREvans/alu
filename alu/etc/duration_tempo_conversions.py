...
tempo_ratios = [Fraction(2, 3), Fraction(1, 1), Fraction(5, 4), Fraction(3, 2), Fraction(7, 4)]
...
for tempo, old_measure, new_measure in zip(tempo_progression, common_time_measures, tempo_adjusted_measures):
    print(f"{old_measure} measures at quarter = {float(tempo)} becomes {new_measure} measures\n")
